<form target="_blank" action="https://formsubmit.co/sakhibullin2004@mail.ru" method="POST"><!-- Опросник -->
	<div id="svyaz" style=""> 
		 <div class="col-md">
		  ...
		  <div class="col-md">
		    <div class="form-floating form-2" >
		      <select class="form-select" id="floatingSelectGrid" aria-label="Floating label select example" name="_subject" type="hidden">
		        <option selected>Хотите дополнить информацию</option>
		        <option value="Пожелания">Пожелания</option>
		        <option value="Нашли ошибку">Нашли ошибку?</option>
		      </select>
		      <label for="floatingSelectGrid">Связаться с нами</label>
		    </div>
		  </div>
		  <div class="form-floating form-3">
...
<script type="text/javascript" src="js/svyaz.js"></script>